  ...
  return (
    <div className='flex flex-row bg-gray-600 text-gray-100 justify-center items-center'>
      ...
      <div className='flex justify-center items-center flex-col'>
        ...
        <div className={`transform flex justify-center items-center text-center ${onDisplay ? 'translate-x-0' : '-translate-x-full'} ease-in-out duration-[3000ms]  transition-transform`}>
        ...
        <div className='flex flex-row mt-2 items-center text-center ml-1'>

          <p>Web App/Software Developer</p>
        </div>

      </div>

      
      <div className="w-[400px] h-[400px] rounded-full bg-gray-800 overflow-hidden my-4 mx-5">
